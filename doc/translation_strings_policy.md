...
This document provides guidelines for internationalization of the Utopiacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `utopiacoin_en.ts` remains unchanged.
