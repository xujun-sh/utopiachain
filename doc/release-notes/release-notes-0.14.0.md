...
- #7562 `1eef038` Bump transaction version default to 2 (UTCdrak)
...
- #8608 `7e9ab95` Install manpages via make install, also add some autogenerated manpages (nomnomUTC)
...
- #8568 `078900d` new var `DIST_CONTRIB` adds useful things for packagers from contrib (nomnomUTC)
...
- #9206 `e662d28` Make test constant consistent with consensus.h (UTCdrak)
