...
*/
	...
	genesis = CreateGenesisBlock(1525471814, 85862786, 0x1d00ffff, 1, 21000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000000095aca60d4f671005ab7baae1d3bb20c580078016193d25eee02f57b7"));     //--// need to put in new hash of genesis block
       ...
       //--// vSeeds.emplace_back("seed.UTC.petertodd.org", true); // Peter Todd, only supports x1, x5, x9, and xd
        ...
        checkpointData = {
            {
                { 0, uint256S("0x0000000095aca60d4f671005ab7baae1d3bb20c580078016193d25eee02f57b7")},    //--//
    ...
    //--//            {295000, uint256S("0x00000000000000004d9b4ef50f0f9d686fd69db2e03af35a100370c64632a983")},
        ...
        chainTxData = ChainTxData{
            ...
            1525471814,        //--// * UNIX timestamp for genesis block (need to put)
