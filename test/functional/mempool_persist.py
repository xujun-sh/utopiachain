...
By default, utopiacoind will dump mempool on shutdown and
...
class MempoolPersistTest(UtopiacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give utopiacoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent utopiacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
