...
Utopiacoin Core version *version* is now available from:

  <https://utopiacoin.org/bin/utopiacoin-core-*version*/>
...
To receive security and update notifications, please subscribe to:
  ...
  <https://utopiacoincore.org/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/Utopiacoin-Qt` (on Mac)
or `utopiacoind`/`utopiacoin-qt` (on Linux).
...
Utopiacoin Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows Vista and later. Windows XP is not supported.

Utopiacoin Core should also work on most other Unix-like systems but is not
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Utopiacoin Core is now 4.8. No effort will be
