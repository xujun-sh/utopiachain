...
Byteswapped: 76d14b74a832230f175ce96197b135645b798eec65dd672c3c3c376118cc4e36
Generating block...
315835 Hashes/s, Nonce 23283733573
Block found!
Hash: 000000006f9f1d360ed58ea15ccb09b8fbbc443fef44f98407d397df24b01fb6
Nonce: 2328586910
Unix time: 1525616961
*/
	...
	genesis = CreateGenesisBlock(1525616961, 2328586910, 0x1d00ffff, 1, 21000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000006f9f1d360ed58ea15ccb09b8fbbc443fef44f98407d397df24b01fb6"));     //--// need to put in new hash of genesis block
       ...
       //--// vSeeds.emplace_back("seed.UTC.petertodd.org", true); // Peter Todd, only supports x1, x5, x9, and xd
        ...
        checkpointData = {
            {
                { 0, uint256S("0x000000006f9f1d360ed58ea15ccb09b8fbbc443fef44f98407d397df24b01fb6")},    //--//
    ...
    //--//            {295000, uint256S("0x00000000000000004d9b4ef50f0f9d686fd69db2e03af35a100370c64632a983")},
        ...
        chainTxData = ChainTxData{
            ...
            1525616961,        //--// * UNIX timestamp for genesis block (need to put)
