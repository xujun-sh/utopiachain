...
#ifndef UTOPIACOIN_WALLET_WALLET_H
#define UTOPIACOIN_WALLET_WALLET_H
...
public:
     ...
     * on this utopiacoin node, and set to 0 for transactions that were created
...
#endif // UTOPIACOIN_WALLET_WALLET_H
