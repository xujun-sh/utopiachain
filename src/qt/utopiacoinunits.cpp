...
QList<UtopiacoinUnits::Unit> UtopiacoinUnits::availableUnits()
{
    ...
    unitlist.append(UTC);
    unitlist.append(mUTC);
    unitlist.append(uUTC);
    return unitlist;
}
...
QString UtopiacoinUnits::longName(int unit)
{
    switch(unit)
    {
    case UTC: return QString("UTC");
    case mUTC: return QString("mUTC");
    case uUTC: return QString::fromUtf8("µUTC (bits)");
    default: return QString("???");
    }
}

QString UtopiacoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uUTC: return QString::fromUtf8("bits");
...
QString UtopiacoinUnits::description(int unit)
{
    switch(unit)
    {
    case UTC: return QString("Utopiacoins");
    case mUTC: return QString("Milli-Utopiacoins (1 / 1" THIN_SP_UTF8 "000)");
    case uUTC: return QString("Micro-Utopiacoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
qint64 UtopiacoinUnits::factor(int unit)
{
    switch(unit)
    {
    case UTC:  return 100000000;
    case mUTC: return 100000;
    case uUTC: return 100;
...
QString UtopiacoinUnits::getAmountColumnTitle(int unit)
{
    ...
    {
        amountTitle += " ("+UtopiacoinUnits::shortName(unit) + ")";
    }
    return amountTitle;
}
