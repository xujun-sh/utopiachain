...
# TestNode: A peer we use to send messages to utopiacoind, and store responses.
...
class CompactBlocksTest(UtopiacoinTestFramework):
    ...
    # This test actually causes utopiacoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that utopiacoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for utopiacoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # utopiacoind will not send blocktxn responses for blocks whose height is
