...
#include <qt/utopiacoinamountfield.h>
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<UtopiacoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_utopiacoin-qt -platform xcb      # Linux
//     src/qt/test/test_utopiacoin-qt -platform windows  # Windows
//     src/qt/test/test_utopiacoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = UtopiacoinUnits::formatWithUnit(unit, balance, false, UtopiacoinUnits::separatorAlways);
    ...
    // Amount input
    UtopiacoinAmountField* amountInput = receiveCoinsDialog.findChild<UtopiacoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: utopiacoin:")) != -1);
